         ...
         <div className="container mx-auto px-5 pb-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div data-aos="flip-down" className="p-5 drop-shadow-2xl bg-white rounded-md">
               <div className="flex justify-between items-center pb-5">
                  ...
                  <img src="https://www.showtimeevent.com/images/icons/icon-1.png" alt="" />
               </div>
            ...
            <div data-aos="flip-down" className="p-5 drop-shadow-2xl bg-white rounded-md">
               <div className="flex justify-between items-center pb-5">
                  ...
                  <br />   Experienced</h3>
                  <img src="https://www.showtimeevent.com/images/icons/icon-2.png" alt="" />
               </div>
               <p className="text-md lg:text-lg">Showtime events is well experienced and highly trusted in the field of events management service provider. We have served lots of clients and gave them satisfying results.</p>
            </div>
            <div data-aos="flip-down" className="p-5 drop-shadow-2xl bg-white rounded-md">
               <div className="flex justify-between items-center pb-5">
                  <h3 className="text-lg lg:text-2xl font-semibold border-b-2 pb-2 border-gray-500">Innovation
                  <br />   Oriented</h3>
                  <img src="https://www.showtimeevent.com/images/icons/icon-3.png" alt="" />
               </div>
               <p className="text-md lg:text-lg">Showtime events is known for its unique and innovative approach towards every event. We never use traditional methods to establish an event setup.</p>
            </div>
            <div data-aos="flip-down" className="p-5 drop-shadow-2xl bg-white rounded-md">
               <div className="flex justify-between items-center pb-5">
                  <h3 className="text-lg lg:text-2xl font-semibold border-b-2 pb-2 border-gray-500">Different
                  <br />   Approach</h3>
                  <img src="https://www.showtimeevent.com/images/icons/icon-4.png" alt="" />
               </div>
            ...
            <div data-aos="flip-down" className="p-5 drop-shadow-2xl bg-white rounded-md">
               <div className="flex justify-between items-center pb-5">
                  <h3 className="text-lg lg:text-2xl font-semibold border-b-2 pb-2 border-gray-500">Professional
                   <br />  Team</h3>
                  <img src="https://www.showtimeevent.com/images/icons/icon-5.png" alt="" />
               </div>
            ...
            <div data-aos="flip-down" className="p-5 drop-shadow-2xl bg-white rounded-md">
               <div className="flex justify-between items-center pb-5">
                  ...
                  <br />   Services</h3>
                  <img src="https://www.showtimeevent.com/images/icons/icon-6.png" alt="" />
               </div>
